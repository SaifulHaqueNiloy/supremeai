...
| 7 | ~~Rotate `OPENROUTER_API_KEY` (Issue #438)~~ **✅ RESOLVED (2026-09-19)** | Infisical Vault / Render Environment Dashboard | Provisioned active OpenRouter API Key (auth/key endpoint & live chat completion verified with 200 OK); synced into .env. Resolves Issue #438. |
