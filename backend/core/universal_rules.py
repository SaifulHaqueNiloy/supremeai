...
class UniversalRulesEngine:
    ...
    AGENT_RULES_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "config", "agent_rules.json")
    ...
    def _load_rules(self) -> dict[str, Any]:
        ...
        default_rules = {
            ...
            "production_policy": {"no_mocks": True, "no_stubs": True, "production_ready_only": True},
