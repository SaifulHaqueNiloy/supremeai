...
class BiasDetectionAgent:
    ...
    async def assess_mitigation_effectiveness(
        ...
        effectiveness_score = max(0.0, min(1.0, improvement / original_result.severity_score if original_result.severity_score > 0 else 0))
        ...
        return {
            ...
            "bias_reduction_percentage": round((improvement/original_result.severity_score)*100 if original_result.severity_score > 0 else 0, 2),
