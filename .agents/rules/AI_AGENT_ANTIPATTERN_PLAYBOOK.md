...
### ৮. Superficial Document-Trusting Audit (বাসি ডকুমেন্টে অন্ধ বিশ্বাস) ⚠️
- **অ্যান্টি-প্যাটার্ন:** কোনো প্ল্যান বা অডিট ফাইল পড়ে সরাসরি মেনে নেওয়া যে ফাইলে যা লেখা আছে তা পেন্ডিং বা সত্য (যেমন: "SupremeAIService.ts থেকে কোড মুছুন", অথচ ফাইলটি ইতিমধ্যে নেই; অথবা STATUS.md-তে "Pending: None" দেখে ধরে নেওয়া সব ঠিক আছে)।
- **সঠিক পদ্ধতি:** 
  1. অডিটের সময় কোনো ফাইলের নাম বা কোড পাথ এলে আগে `grep_search` করে দেখতে হবে ফাইলটি বর্তমানে বাস্তবে আছে কি না।
  2. সামারি ফাইলের চেয়ে লাইভ টার্মিনাল এক্সিকিউশন (`pytest`, `ruff check`, `git diff`) চালিয়ে গ্রাউন্ড-ট্রুথ এভিডেন্স সংগ্রহ করতে হবে।
  3. `STATUS.md` বনাম `CHECKPOINT.md`-এর মতো ডক্যুমেন্টেশন বৈপরীত্য থাকলে তা স্পষ্টভাবে 'Documentation Desync' হিসেবে রিপোর্ট করতে হবে।
