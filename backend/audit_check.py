...
with open(path, encoding="utf-8") as f:
    ...
    has_admin_auth = (
        "get_current_admin" in content or "require_admin" in content or "verify_admin" in content
    )
...
with open(path, encoding="utf-8") as f:
    ...
    has_except_bare_pass = (
        "except: pass" in content or "except:    pass" in content or "except:  pass" in content
    )
