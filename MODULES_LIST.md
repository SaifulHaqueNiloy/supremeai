...
- 🟢 **Operational:** 127 modules (Importable + active inbound production callers)
...
| 2 | Monorepo Package | packages/design-tokens | 🟢 Operational | backend/tools/social/telegram_bot/conversations.py | None | unassigned | retain |
| 3 | Monorepo Package | packages/scripts | 🟢 Operational | 10 callers (backend/core/errors/error_remediation.py, ...) | 8 tests (backend/tests/conftest.py, ...) | unassigned | retain |
...
| 6 | Monorepo Package | packages/ui-components | 🟢 Operational | frontend/src/components/swarm/SwarmHealthDashboard.tsx, frontend/src/main.tsx | 3 tests (frontend/src/App.tsx, ...) | unassigned | retain |
| 7 | Backend Core Service | backend/services/billing | 🟢 Operational | 18 callers (backend/api/routes/admin_dashboard/__init__.py, ...) | 13 tests (backend/tests/conftest.py, ...) | unassigned | retain |
| 8 | Backend Core Service | backend/services/browser | 🟢 Operational | 61 callers (backend/api/routers.py, ...) | 38 tests (frontend/src/components/admin/AdminBrowserPanel.tsx, ...) | unassigned | retain |
| 9 | Backend Core Service | backend/services/data | 🟢 Operational | 155 callers (backend/api/routes/admin.py, ...) | 200 tests (backend/tests/conftest.py, ...) | unassigned | retain |
| 10 | Backend Core Service | backend/services/dynamic_ai | 🟢 Operational | 4 callers (backend/api/routes/admin_dashboard/endpoints_metrics.py, ...) | None | unassigned | retain |
| 11 | Backend Core Service | backend/services/email | 🟢 Operational | 37 callers (backend/api/dependencies.py, ...) | 22 tests (backend/tests/conftest.py, ...) | unassigned | retain |
...
| 15 | Backend Core Service | backend/services/llm | 🟢 Operational | 66 callers (backend/api/routes/advanced_router.py, ...) | 6 tests (backend/tests/conftest.py, ...) | unassigned | retain |
...
| 58 | Backend Tool / Utility | backend/tools/health_checker.py | 🟢 Operational | 3 callers (backend/api/routes/admin_dashboard/endpoints_health.py, ...) | None | unassigned | retain |
...
| 71 | Backend Tool / Utility | backend/tools/tenant_rate_limiter.py | 🟢 Operational | backend/api/routes/mcp_marketplace.py, backend/api/routes/tenant_admin.py | None | unassigned | retain |
| 72 | Backend Tool / Utility | backend/tools/ai_agents/browser_agent.py | 🟢 Operational | 10 callers (backend/api/routes/browser/__init__.py, ...) | None | unassigned | retain |
...
| 76 | Backend Tool / Utility | backend/tools/billing/cost_auditor.py | 🟢 Operational | backend/api/routes/admin_dashboard/__init__.py, backend/api/routes/billing_api.py | None | unassigned | retain |
...
| 78 | Backend Tool / Utility | backend/tools/browser/ai_web_extractor.py | 🟢 Operational | backend/api/routes/browser/_scraping.py | None | unassigned | retain |
| 79 | Backend Tool / Utility | backend/tools/browser/browser_stealth.py | 🟢 Operational | backend/core/human_behavior.py, backend/tools/browser/playwright_browser_agent.py | None | unassigned | retain |
...
| 84 | Backend Tool / Utility | backend/tools/browser/web_scraper.py | 🟢 Operational | 9 callers (backend/api/routes/admin_dashboard/endpoints_command.py, ...) | None | unassigned | retain |
...
| 111 | Backend Tool / Utility | backend/tools/knowledge/codebase_exporter.py | 🟢 Operational | backend/api/routes/admin_dashboard/__init__.py, backend/api/routes/markdown.py | None | unassigned | retain |
...
| 141 | Backend Tool / Utility | backend/tools/social/teldrive_storage.py | 🟢 Operational | backend/tools/social/telegram_bot/admin_handlers.py | None | unassigned | retain |
| 142 | Backend Tool / Utility | backend/tools/social/telegram_bot.py | 🔴 Broken | 4 callers (backend/core/messaging/adapters.py, ...) | None | unassigned | review |
| 143 | Backend Tool / Utility | backend/tools/social/telegram_security.py | 🟢 Operational | backend/api/routes/workspaces_route.py, backend/tools/social/telegram_bot/updates.py | None | unassigned | retain |
...
| 152 | Frontend Page / View | frontend/src/pages/admin | 🟢 Operational | 209 callers (backend/api/dependencies.py, ...) | 134 tests (backend/tests/conftest.py, ...) | unassigned | retain |
| 153 | Frontend Page / View | frontend/src/pages/auth | 🟢 Operational | 78 callers (backend/api/middleware.py, ...) | 51 tests (backend/tests/conftest.py, ...) | unassigned | retain |
| 154 | Frontend Page / View | frontend/src/pages/user | 🟢 Operational | 122 callers (backend/api/dependencies.py, ...) | 89 tests (backend/tests/conftest.py, ...) | unassigned | retain |
...
| 159 | Frontend Service Module | frontend/src/services/api | 🟢 Operational | 463 callers (backend/api/__init__.py, ...) | 141 tests (backend/tests/api/routes/commandcenter/__init__.py, ...) | unassigned | retain |
| 160 | Frontend Service Module | frontend/src/services/apiClient.ts | 🟢 Operational | 94 callers (backend/core/app_builder.py, ...) | 95 tests (frontend/src/commandcenter/data/hooks.ts, ...) | unassigned | retain |
...
| 170 | Frontend Service Module | frontend/src/services/queryClient.ts | 🟠 Partially Wired | 0 active callers (dormant) | 4 tests (frontend/src/components/admin/EnhancedSkillMarketplace.tsx, ...) | unassigned | owner-review |
| 171 | Frontend Service Module | frontend/src/services/realtime | 🟢 Operational | 12 callers (backend/api/routes/metrics.py, ...) | 9 tests (frontend/src/App.tsx, ...) | unassigned | retain |
| 172 | Frontend Service Module | frontend/src/services/sandbox.ts | 🟢 Operational | 14 callers (backend/api/routes/sandbox_api.py, ...) | 14 tests (frontend/src/components/admin/CommandCenter.tsx, ...) | unassigned | retain |
