...
| `SUPABASE_URL` + `SUPABASE_SERVICE_ROLE_KEY` | Infisical `prod` → Render | YES | core | 🟡 present-in-vault; API reachable: `https://<render-primary-url>/health/ready` → `ready` ✅ | 2026-09-14 |
