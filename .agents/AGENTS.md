...
- **সাময়িক ম্যানুয়াল ডিপ্লয়মেন্ট নীতি (Temporary Manual Push Rule):**
  - যেহেতু GitHub Actions থেকে Render-এ পুশ করলে বিশাল এরর হচ্ছে, তাই রুট কজ (Root Cause) বের করা এবং সবকিছু ফিক্স না হওয়া পর্যন্ত আমরা সরাসরি (ম্যানুয়ালি) Render এবং Firebase-এ লোকাল থেকে পুশ/ডিপ্লয় করে টেস্ট করব।।

- **জিরো-টলারেন্স এরর রেজল্যুশন নীতি (Zero-Tolerance Error Resolution Rule):** যেকোনো ছোট বা মাইনর ওয়ার্নিং/এরর দেখা গেলে সেটিকে ইগনোর বা স্কিপ করা যাবে না। শুরুতেই রুট কজ বের করে তা পুরোপুরি সমাধান করে ফেলতে হবে, যাতে পরবর্তীতে এটি কোনো বড় সমস্যার কারণ না হয়।

- **কন্টিনিউয়াস লার্নিং ও এরর লগিং নীতি (Continuous Learning & Error Logging Rule):** প্রজেক্টে যেকোনো নতুন এরর, বাগ বা মিস্টেক ধরা পড়লে এবং তা সমাধান করার পর আবশ্যিকভাবে `docs/LESSONS_LEARNED.md` ফাইলটি আপডেট করতে হবে। এররগুলোকে তাদের ধরন অনুযায়ী (যেমন: DevOps/Deployment, Security/Secrets, Frontend-Backend Connection, Syntax/Logic) স্পেসিফিক ক্যাটাগরিতে (Group-wise) লিপিবদ্ধ করতে হবে।
