...
id: auto:agent_and_engineer_skill_requirements
subject: Skill Requirements
...
- **Infrastructure**
  ...
  - Cloud platforms (GCP/AWS) (Advanced)
...
- **Monitoring**
  ...
  - Logging (ELK stack) (Intermediate)
...
- **Test Management**
  - Test planning (Advanced)
  - Bug tracking (JIRA) (Advanced)
...
- **Collaboration**
  ...
  - Cross-functional teamwork (Advanced)
  - Knowledge sharing (Intermediate)

- **Problem Solving**
  - Analytical thinking (Advanced)
  - Debugging skills (Intermediate)
