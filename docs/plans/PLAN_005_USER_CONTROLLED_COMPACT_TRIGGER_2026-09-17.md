...
depends_on:
  - backend/api/routes/websocket_agent.py (implemented PLAN-002 machinery — _compact_history L449–497, WS chat loop L555–616, deque(maxlen=50) L554)
