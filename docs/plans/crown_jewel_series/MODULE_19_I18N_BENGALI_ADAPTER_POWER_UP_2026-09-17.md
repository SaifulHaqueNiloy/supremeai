...
ক্রম P-D→P-A→P-B→P-C→P-E→P-F→P-G→P-H; প্রতিটি P = আলাদা ছোট execution-প্ল্যান (Gate 2-পরবর্তী); P-D-তে parity-টেস্ট (পুরনো-ক্যালকুলাস-বনাম-নতুন বাংলা-ক্ষেত্রে), NFC-সমতা-টেস্ট (NFC/NFD/ZWNJ-বিকল্প এক-ফল); P-A-তে ক্যাটালগ-সম্পূর্ণতা-চেক P-G-র চেকার-সহ; P-E-তে dual-read স্থানান্তর (ERR-F02); রেশিও-ক্যালিব্রেশন বাস্তব-টোকেনাইজার-মাপে (পরিমাপ-নথি); সব env V5.1-সংগত
