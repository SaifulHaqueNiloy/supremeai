        ...
        <div className="rounded-xl border border-[var(--sa-line)] bg-[var(--sa-bg-1)] p-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <Sparkline data={Array.from({ length: 30 }, () => Math.random() * 50 + 20)} height={32} color="#00f3ff" />
            ...
            <div className="flex items-center gap-3">
              ...
              <Sparkline data={Array.from({ length: 30 }, () => Math.random() * 100 + 50)} height={32} color="#f59e0b" />
            ...
            <div className="flex items-center gap-3">
              ...
              <Sparkline data={Array.from({ length: 30 }, () => Math.random() * 150 + 80)} height={32} color="#ef4444" />
