...
এই ফাইলে আমরা প্রজেক্ট ডেভেলপমেন্টের সময় হওয়া বিভিন্ন ভুল (Mistakes), বাগ (Bugs) এবং তাদের স্পেসিফিক সমাধানগুলো (Solutions) শর্ট করে লিস্ট করে রাখব, যাতে ভবিষ্যতে একই ভুল দ্বিতীয়বার না হয়।
...
## ২. Frontend-Backend CORS Connection Error
...
## ৩. Missing Optional Secrets Causes Server Crash
...
## ৪. pnpm Workspace URL Error in Render
...
---
*নতুন কোনো বড় এরর ফেস করলে এবং তার সমাধান পেলে এখানে যুক্ত করতে হবে।*
