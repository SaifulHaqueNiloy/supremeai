...
def _try_mock(name, is_package=False):
    try:
        if importlib.util.find_spec(name) is None:
            sys.modules[name] = create_mock_module(name, is_package=is_package)
            return True
...
_try_mock("slowapi", is_package=True)
_try_mock("slowapi.util")
_try_mock("pinecone", is_package=True)
...
_try_mock("nats", is_package=True)
_try_mock("nats.aio", is_package=True)
_try_mock("nats.aio.client")
_try_mock("nats.errors")
_try_mock("docker", is_package=True)
_try_mock("docker.errors")
_try_mock("typer", is_package=True)
_try_mock("resend", is_package=True)
_try_mock("resend.emails")
_try_mock("pandas")
_try_mock("matplotlib")
_try_mock("chromadb", is_package=True)
_try_mock("chromadb.config")
_try_mock("chromadb.utils", is_package=True)
_try_mock("chromadb.utils.embedding_functions")
_try_mock("analytics")
_try_mock("sentry_sdk", is_package=True)
_try_mock("sentry_sdk.integrations", is_package=True)
_try_mock("sentry_sdk.integrations.loguru")
_try_mock("alembic", is_package=True)
_try_mock("alembic.config")
_try_mock("alembic.migration", is_package=True)
_try_mock("alembic.operations")
_try_mock("alembic.runtime", is_package=True)
_try_mock("alembic.runtime.migration")
_try_mock("stripe", is_package=True)
_try_mock("stripe.error")
_try_mock("websockets", is_package=True)
_try_mock("litellm", is_package=True)
_try_mock("opentelemetry", is_package=True)
_try_mock("opentelemetry.sdk", is_package=True)
_try_mock("opentelemetry.sdk.trace", is_package=True)
_try_mock("opentelemetry.instrumentation", is_package=True)
_try_mock("opentelemetry.instrumentation.fastapi")
_try_mock("opentelemetry.exporter", is_package=True)
_try_mock("opentelemetry.exporter.otlp", is_package=True)
_try_mock("opentelemetry.exporter.otlp.proto", is_package=True)
_try_mock("opentelemetry.exporter.otlp.proto.grpc")
_try_mock("asyncpg", is_package=True)
_try_mock("asyncpg.connection")
_try_mock("asyncpg.pool")
_try_mock("posthog")
_try_mock("neo4j", is_package=True)
_try_mock("tools.code.image_to_code_react")
_try_mock("tools.cache_cleanup")
_try_mock("tools.code.code_smell_detector")
_try_mock("opentelemetry.sdk.trace.export")
_try_mock("opentelemetry.exporter.otlp.proto.grpc.trace_exporter")
_try_mock("opentelemetry.proto", is_package=True)
_try_mock("opentelemetry.proto.collector", is_package=True)
_try_mock("opentelemetry.proto.collector.trace", is_package=True)
_try_mock("opentelemetry.proto.collector.trace.v1")
_try_mock("opentelemetry.sdk.environment_variables")
_try_mock("opentelemetry._logs", is_package=True)
_try_mock("opentelemetry.sdk._logs", is_package=True)
_try_mock("opentelemetry.sdk._logs.export")
_try_mock("opentelemetry.metrics", is_package=True)
_try_mock("opentelemetry.sdk.metrics", is_package=True)
_try_mock("opentelemetry.sdk.metrics.export")
_try_mock("opentelemetry.resource", is_package=True)
_try_mock("opentelemetry.trace", is_package=True)
_try_mock("opentelemetry.sdk.trace", is_package=True)
_try_mock("opentelemetry.trace.export")
_try_mock("google.oauth2", is_package=True)
_try_mock("google.oauth2.credentials")
_try_mock("google.oauth2.service_account")
_try_mock("google.auth")
_try_mock("google.cloud", is_package=True)
_try_mock("google.cloud.firestore")
_try_mock("google.cloud.secretmanager")
_try_mock("google.cloud.storage")
_try_mock("google_auth_httplib2")
_try_mock("google_auth_oauthlib")
...
_try_mock("grpc", is_package=True)
_try_mock("google", is_package=True)
_try_mock("google.auth")
_try_mock("google.cloud", is_package=True)
_try_mock("google.cloud.firestore")
_try_mock("google.cloud.secretmanager")
...
_try_mock("mcp.server")
_try_mock("mcp.server.stdio")
_try_mock("google.oauth2", is_package=True)
