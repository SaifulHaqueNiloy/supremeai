...
প্রতিটি P = আলাদা ছোট execution-প্ল্যান (Gate 2 পরবর্তী); সাধারণ-ক্রম P-G→P-D→P-B→P-A→P-C→P-E→P-F→P-H; প্রতিটিতে: টেস্ট-আগে, env-নামকরণ V5.1-সংগত, shim+deprecation-নোট, baseline-N র‍্যাচেট (নতুন ইন-কোড পলিসি-লিটারেল = fail, পুরনো N-তালিকাভুক্ত); P-C-তে bounded-queue+ltrim-অভ্যাস (B-11-প্যাটার্ন); P-B-তে YAML-লোড-fail→last-known-good+loud-log (fail-safe-ডেটা)
