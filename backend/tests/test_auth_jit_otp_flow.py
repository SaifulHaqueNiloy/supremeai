"""Integration tests for JIT OTP authentication flow.

বাংলা: JIT (Just-In-Time) OTP প্রমাণীকরণ ফ্লো — Discord, Email, Telegram, WhatsApp চ্যানেল সহ।
"""
...
class TestJITOTPFlow:
    """Tests for JIT OTP authentication flow."""
