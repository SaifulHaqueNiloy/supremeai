...
from core.lifespan import app_lifespan, _ensure_api_key_tables
...
class TestAppLifespan:
    ...
    async def test_handles_teardown_errors(self):
        ...
        with contextlib.ExitStack() as stack:
            ...
            stack.enter_context(patch("core.lifespan.ReliabilityController.initialize", new_callable=AsyncMock))
            stack.enter_context(patch("core.observability.telemetry.setup_tracing", return_value=None))
