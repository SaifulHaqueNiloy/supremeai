...
class TestAISecretAnalyzer:
    ...
    def test_analyze_finding_success(self):
        ...
        with patch("core.security.secret_hunter.llm_gateway.acomplete", side_effect=mock_acomplete):
    ...
    def test_analyze_finding_false_positive(self):
        ...
        with patch("core.security.secret_hunter.llm_gateway.acomplete", return_value=mock_response):
            import asyncio
