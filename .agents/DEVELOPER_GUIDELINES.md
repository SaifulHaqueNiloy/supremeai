> **নোট (Scope & Authority):** এই ম্যানিফেস্টোটি সাধারণ ডেভেলপারদের জন্য কোড কোয়ালিটি হ্যান্ডবুক। অটোনোমাস এআই এজেন্টদের জন্য চূড়ান্ত সংবিধান ও গাইডলাইন হলো রুট **`AGENTS.md`** এবং **`.agents/prompts/MASTER_KICKOFF_PROMPT.md`**।
...
২১. **Main Branch Discipline:** সাধারণ মানব ডেভেলপারদের জন্য PR ও রিভিউ বাধ্যতামূলক; তবে অটোনোমাস এআই এজেন্ট সমস্ত টেস্ট গেট পাস করে সরাসরি ক্যানোনিক্যাল `main` ব্রাঞ্চে পুশ করবে (AGENTS.md নীতি অনুযায়ী)।
