"""Shared constants and helpers for the admin_dashboard router package.

Extracted verbatim from the original monolithic ``api/routes/admin_dashboard.py``
so the domain sub-modules (users, costs, ops, config, commandcenter, ...) can
reuse one implementation. Nothing here registers routes.
"""
