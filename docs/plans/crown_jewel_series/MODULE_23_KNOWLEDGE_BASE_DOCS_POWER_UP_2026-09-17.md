...
ক্রম-শৃঙ্খলা (নির্ভরতা-ভিত্তিক, প্রতিটি ছোট founder-reviewable execution-প্ল্যানে): **P-A → P-C → P-G → P-E → P-D → P-B → P-F → P-H**। P-A প্রথম (৩-লাইন + টেস্ট — দরজা খোলে); P-C adapter লেখে (বই-পথ খোলে; NVIDIA/arXiv-চাংকিং-গবেষণা অনুসারে config-চালিত token-বাজেট-নীতি rag_pipeline-এ, ডিফল্ট অপরিবর্তিত-আচরণ); P-G normalization+eval-gate (বাংলা-প্রমাণ); P-E/P-D সততা+নবায়নযোগ্যতা (register-মতবাদ-প্রয়োগ); P-B কনসলিডেশন (founder-gated সিদ্ধান্ত-পয়েন্টসহ); P-F/P-H সারফেস। সব নীতি ডেটা-ফাইলে (knowledge_policy.json প্রস্তাব — চাংক/ফ্রেশনেস/role এক ফাইলে, Module 15 P-B-প্রেসিডেন্ট); কোনো নতুন নির্ভরতা/ভেন্ডর/DB নয়; সব টেস্ট নিজস্ব-harness (RAGAS-প্রত্যাখ্যান)।
