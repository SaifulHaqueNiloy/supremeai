...
def validate_ast(source: str) -> None:
    ...
    try:
        ...
        raise ValueError(f"Syntax error during validation: {e}") from e
...
def run_restricted(source: str, locals_: dict[str, Any] | None = None) -> tuple[bool, dict[str, Any] | str]:
    ...
    try:
        ...
        exec(
            byte_code, globals_, locals_
        )  # noqa: S102 -- RestrictedPython compiled bytecode, sandboxed builtins whitelist
        return True, locals_
