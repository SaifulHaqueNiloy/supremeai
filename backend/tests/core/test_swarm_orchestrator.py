...
def mock_agents():
    ...
    with (
        patch(
            "core.orchestration.swarm_orchestrator.ArchitectureAgent", return_value=mock_architect
        ),
        ...
        patch(
            "core.orchestration.swarm_orchestrator.ReflectionAgent", return_value=mock_reflection
        ),
    ):
