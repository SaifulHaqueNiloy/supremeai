...
async def demo_digital_twin():
    ...
    logger.info("Initializing Digital Twin World Model...")
    ...
    logger.info(f"Overall health: {state['health_summary']['overall_health_percentage']:.1f}%")
    logger.info(f"Active remediation plans: {state['health_summary']['active_remediation_plans']}")
