...
| 7.4 | Sweep remaining routes returning `str(e)` to clients (`keys.py:67`, `conversations.py:48,68`, `preferences.py:104`, `admin.py:52`) → generic 500s with correlation IDs. | Code sweep, low risk but broad |
