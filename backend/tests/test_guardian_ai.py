...
class TestPromptInjectionDefender:
    ...
    async def test_ai_deep_scan_success(self):
        ...
        with patch("core.security.guardian_ai.llm_gateway.acompletion", side_effect=mock_acomplete):
    ...
    async def test_ai_deep_scan_failure_fallback(self):
        ...
        with patch("core.security.guardian_ai.llm_gateway.acompletion", side_effect=Exception("API error")):
            result = await defender.ai_deep_scan("Hello world")
...
class TestGuardianAI:
    ...
    def test_check_output_delegates(self):
        ...
        with patch.object(
            ...
            result = guardian.check_output("Hello")
