...
ROLE_PERMISSIONS: dict[WorkspaceRole, list[Permission]] = {
    WorkspaceRole.OWNER: [Permission.READ, Permission.WRITE, Permission.DELETE, Permission.SHARE, Permission.ADMIN, Permission.EXECUTE],
    WorkspaceRole.ADMIN: [Permission.READ, Permission.WRITE, Permission.DELETE, Permission.SHARE, Permission.ADMIN],
