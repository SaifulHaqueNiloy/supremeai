// ══════════════════════════════════════════════════════════════════════════════
// CI Dashboard — Tab Panels (Overview & Jobs)
...
import type { CISummaryData, JobResult, TrendPoint } from './CIDashboard.types';
import { COLORS } from './CIDashboard.constants';
import { InsightCard, JobRow, ProgressBar } from './CIDashboardWidgets';

export function OverviewTab({ data, showTrends, trendChartData }: { data: CISummaryData; showTrends: boolean; trendChartData: TrendPoint[] }) {
...
export function JobsTab({ data, onJobClick }: { data: CISummaryData; onJobClick: (job: JobResult) => void }) {
  return (
    <div className="space-y-3">
