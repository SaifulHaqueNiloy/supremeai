          ...
          <section className="w-full">
            ...
            <div className="rounded-3xl border border-[var(--supremeai-color-border-default-light)] bg-white p-7 shadow-[0_18px_50px_rgba(17,22,21,0.08)] dark:border-[var(--supremeai-color-border-default-dark)] dark:bg-[var(--supremeai-color-bg-elevated-dark)] dark:shadow-none sm:p-9">
              ...
              <form onSubmit={handleLogin} className="space-y-5">
                ...
                <label className="block text-sm font-medium" htmlFor="login-password">Password<input id="login-password" name="password" data-testid="password-input" autoComplete="current-password" type="password" placeholder="Enter your password" value={password} onChange={e => setPassword(e.target.value)} className="mt-2 w-full rounded-xl border border-[var(--supremeai-color-border-default-light)] bg-[var(--supremeai-color-bg-void-light)] px-4 py-3 outline-none transition focus:border-[var(--supremeai-color-primary-light)] focus:ring-4 focus:ring-[var(--supremeai-color-primary-soft-light)] dark:border-[var(--supremeai-color-border-default-dark)] dark:bg-[var(--supremeai-color-bg-void-dark)] dark:focus:border-[var(--supremeai-color-primary-dark)]" /></label>
                <button type="submit" data-testid="login-submit" disabled={isLoading} className="w-full rounded-xl bg-[var(--supremeai-color-primary-light)] px-4 py-3 font-semibold text-white transition hover:brightness-95 focus:outline-none focus:ring-4 focus:ring-[var(--supremeai-color-primary-soft-light)] disabled:cursor-not-allowed disabled:opacity-60 dark:bg-[var(--supremeai-color-primary-dark)]">{isLoading ? 'Signing in…' : 'Sign in'}</button>
