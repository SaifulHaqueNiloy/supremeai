  ...
  return (
    <div className="flex min-h-0 w-full flex-1 overflow-hidden bg-[#0d0f12] text-slate-100">
      ...
      <main className="flex min-w-0 flex-1 flex-col">
        ...
        <div className="grid min-h-0 flex-1 grid-cols-[minmax(240px,1fr)_minmax(320px,1.35fr)_minmax(280px,1fr)] gap-3 overflow-auto p-3 max-2xl:grid-cols-[minmax(220px,0.9fr)_minmax(300px,1.2fr)_minmax(260px,0.9fr)] max-xl:grid-cols-[minmax(280px,1fr)_minmax(320px,1.15fr)] max-xl:[&>section:last-child]:col-span-2 max-lg:flex max-lg:flex-col max-lg:overflow-y-auto">
