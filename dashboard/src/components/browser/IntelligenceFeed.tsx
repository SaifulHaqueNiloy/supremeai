...
const IntelligenceFeed: React.FC<IntelligenceFeedProps> = ({ activities, findings }) => {
  return (
              ...
              children: (
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <span style={{ color: 'rgba(255,255,255,0.2)', fontSize: 10 }}>{new Date(act.timestamp).toLocaleTimeString()}</span>
                  </div>
