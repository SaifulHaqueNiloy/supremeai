...
class AutoReport(Base):
    ...
    report_type: Mapped[str] = mapped_column(String(50), nullable=False, index=True)  # trend, anomaly, summary, forecast
...
class RetentionAction(Base):
    ...
    action_type: Mapped[str] = mapped_column(String(100), nullable=False)  # push_notification, discount, personal_call, etc.
