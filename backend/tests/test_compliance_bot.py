...
class TestConsentManager:
    ...
    def test_get_consent_status(self, consent_manager, mock_firestore):
        ...
        mock_docs = []
        mock_doc = MagicMock()
        mock_doc.to_dict.return_value = {"user_id": "user123", "consent_type": "data_processing", "granted": True}
...
class TestComplianceBot:
    ...
    def test_run_compliance_check_returns_report(self, compliance_bot):
        ...
        with (
            ...
            patch.object(compliance_bot.dsa, "check_lawful_interception_readiness", return_value=None),
