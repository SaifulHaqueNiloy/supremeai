#!/usr/bin/env python3
"""Helper: write permission_cache.py in parts."""
import os
...
target = r'f:\supremeai backup\backend\core\permission_cache.py'
with open(target, 'a', encoding='utf-8') as f:
    f.write(PART2)
print(f"Part 2 appended ({len(PART2.splitlines())} lines)")
