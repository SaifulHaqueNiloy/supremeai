...
আটটি প্রস্তাব (ক্রম ভিত্তি→সত্য→একতা; সব ফাউন্ডার-রিভিউযোগ্য):
...
ক্রম P-A→P-B→P-C→P-D→P-H→P-G→P-E→P-F; প্রতিটি P = আলাদা ছোট execution-প্ল্যান (Gate 2-পরবর্তী); P-A-তে টেস্ট-প্রথম (due/disabled/catch-up ত্রি-পথ + দ্বৈত-নির্বাহ-প্রতিরোধ idempotency-কী); P-D-তে লুপ-প্রতি স্থানান্তর-টেস্ট (ERR-F02 শিম-প্রথম); P-H-তে TZ-গণনা-টেস্ট (Dhaka-ভোর বনাম UTC-রাত); সব env V5.1-সংগত
