...
class TestDockActions:
    ...
    async def test_run_dock_integration_success(self):
        ...
        from api.routes.dock_actions import run_dock_integration, DockActionPayload
        ...
        with patch("api.routes.dock_actions.get_user_github_token", new=AsyncMock(return_value="gh-token")):
    ...
    async def test_run_dock_integration_missing_token(self):
        ...
        with patch("api.routes.dock_actions.get_user_github_token", new=AsyncMock(return_value=None)):
