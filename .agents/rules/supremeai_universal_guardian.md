...
8. **User-Preferred Language (ব্যবহারকারীর পছন্দের ভাষা):** ব্যবহারকারী যে ভাষায় যোগাযোগ করবেন বা অনুরোধ করবেন (User's preferred language, যেমন: বাংলা, English ইত্যাদি), সর্বদাই সেই ভাষায় সমস্ত ব্যাখ্যা, অগ্রগতি রিপোর্ট এবং টেকনিক্যাল পর্যালোচনা উপস্থাপন করতে হবে। কোড সিনট্যাক্স, ফাইল পাথ, কমান্ড এবং স্ট্যান্ডার্ড টেকনিক্যাল টার্ম যথারীতি অপরিবর্তিত থাকবে।
