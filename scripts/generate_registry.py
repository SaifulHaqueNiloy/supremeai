...
_REG = [
    ...
    ("INFISICAL_TOKEN", "rb:C,ra:C,rw:C,iv:C", "Infisical project access token (vault boot)"),
    ("INFISICAL_CLIENT_SECRET", "rb:C,ra:C,rw:C,iv:C", "Infisical client secret (vault boot)"),
