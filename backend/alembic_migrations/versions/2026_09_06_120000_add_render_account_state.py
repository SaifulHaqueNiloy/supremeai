...
def upgrade() -> None:
    ...
    op.create_index("ix_render_account_states_status_recheck", "render_account_states", ["status", "recheck_at"])
    op.create_table(
    ...
    op.create_index("ix_render_preflight_events_account_observed", "render_preflight_events", ["account_key", "observed_at"])


def downgrade() -> None:
    op.drop_index("ix_render_preflight_events_account_observed", table_name="render_preflight_events")
