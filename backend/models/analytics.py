...
class AutoReport(Base):
    ...
    metrics_json: Mapped[dict] = mapped_column(JSON().with_variant(JSONB, "postgresql"), nullable=False, default=dict)  # extracted metrics
...
class ChurnPrediction(Base):
    ...
    factors_json: Mapped[dict] = mapped_column(JSON().with_variant(JSONB, "postgresql"), nullable=False, default=dict)  # top contributing factors
    recommended_actions: Mapped[list] = mapped_column(JSON().with_variant(JSONB, "postgresql"), nullable=False, default=list)
