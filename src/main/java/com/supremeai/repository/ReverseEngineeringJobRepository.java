...
/**
 * Firestore repository for ReverseEngineeringJob entities.
 * Collection: "reverse_engineering_jobs"
 */
@Repository
public interface ReverseEngineeringJobRepository extends FirestoreReactiveRepository<ReverseEngineeringJob> {
